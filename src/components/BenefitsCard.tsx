...
// Mirrors SalaryCard/WorkStyleCard's truncate-then-expand treatment for the
// same reason: a long comment in a half-width grid cell both hurts
// scannability and, via the grid's default row-stretch, drags an
...
type BenefitsCardProps = {
  ...
  mealPolicyLabel: string;
  transportationPolicyLabel: string;
  equipmentSupportLabel: string;
  comment?: string | null;
  isAnonymous?: boolean;
